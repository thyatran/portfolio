...
const Contacts = () => {
  return (
    <div className="flex flex-wrap justify-start gap-4 p-4 sm:gap-6 sm:p-6">
      {/* RESUME */}
      <a
      ...
      >
        <div className="relative inline-flex -translate-x-0 items-center transition group-hover:-translate-x-6">
          ...
          <span className="pl-6">Resume</span>
      ...
      >
        <div className="relative inline-flex -translate-x-0 items-center transition group-hover:-translate-x-6">
          ...
          <span className="pl-6">LinkedIn</span>
          <div className="absolute right-0 translate-x-12 opacity-0 transition group-hover:translate-x-6 group-hover:opacity-100">
            <svg
              width="15"
              height="15"
